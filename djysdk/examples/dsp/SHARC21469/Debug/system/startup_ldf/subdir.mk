...
system/startup_ldf/%.doj: ../system/startup_ldf/%.s
	...
	easm21k.exe -file-attr ProjectName="SHARC21469" -proc ADSP-21469 -si-revision any -g -swc -D_DEBUG -i"D:\djysdk\djyos_dsp_project\examples\SHARC21469\system" -gnu-style-dependencies -MM -Mo "$(basename $@).d" -o "$@" "$<"
