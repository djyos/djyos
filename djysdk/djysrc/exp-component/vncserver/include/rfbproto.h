...
typedef struct {
    u8 type;            /* always rfbFramebufferUpdate */
    u8 pad;
    u16 nRects;
...
typedef struct {
    rfbRectangle r;
    u32 encoding;   /* one of the encoding types rfbEncoding... */
...
typedef struct {
    u8 type;            /* always rfbSetColourMapEntries */
    u8 pad;
    u16 firstColour;
    u16 nColours;

    /* Followed by nColours * 3 * u16
...
typedef struct {
    u8 type;            /* always rfbServerCutText */
    u8 pad1;
    u16 pad2;
    u32 length;
...
typedef struct {
    u8 type;            /* always rfbSetPixelFormat */
    u8 pad1;
    u16 pad2;
...
typedef struct {
    u8 type;            /* always rfbFixColourMapEntries */
    u8 pad;
    u16 firstColour;
    u16 nColours;
...
typedef struct {
    u8 type;            /* always rfbSetEncodings */
    u8 pad;
    u16 nEncodings;
    /* followed by nEncodings * u32 encoding types */
} rfbSetEncodingsMsg;
...
typedef struct {
    u8 type;            /* always rfbFramebufferUpdateRequest */
    u8 incremental;
    u16 x;
    u16 y;
    u16 w;
...
typedef struct {
    u8 type;            /* always rfbKeyEvent */
    u8 down;            /* true if down (press), false if up */
    u16 pad;
    u32 key;            /* key is specified as an X keysym */
} rfbKeyEventMsg;
...
typedef struct {
    u8 type;            /* always rfbPointerEvent */
    u8 buttonMask;      /* bits 0-7 are buttons 1-8, 0=up, 1=down */
    u16 x;
    u16 y;
} rfbPointerEventMsg;
...
typedef struct {
    u8 type;            /* always rfbClientCutText */
    u8 pad1;
    u16 pad2;
    u32 length;
    /* followed by char text[length] */
