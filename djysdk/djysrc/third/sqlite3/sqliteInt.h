...
**     SQLITE_DJYOS_MALLOC           // Use djyos native heap API
...
*/
  ...
  + defined(SQLITE_DJYOS_MALLOC) \
  + defined(SQLITE_ZERO_MALLOC) \
  + defined(SQLITE_MEMDEBUG)>1
# error "Two or more of the following compile-time configuration options\
 are defined but at most one is allowed:\
 SQLITE_SYSTEM_MALLOC, SQLITE_WIN32_MALLOC, SQLITE_DJYOS_MALLOC,SQLITE_MEMDEBUG,\
 SQLITE_ZERO_MALLOC"
#endif
#if defined(SQLITE_SYSTEM_MALLOC) \
  + defined(SQLITE_WIN32_MALLOC) \
...
#else
typedef UINT32_TYPE tRowcnt;    /* 32-bit is the default */
#endif
