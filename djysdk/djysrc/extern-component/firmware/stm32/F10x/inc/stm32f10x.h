...
#include "board-config.h"     //注:这句是为了在djyos中使用而添加的,库升级时须重新添加
...
/* Wake-UpFrame Filter Reg0 : Filter 0 Byte Mask
   ...
   Wake-UpFrame Filter Re6 : Filter1 Crc_16 - Filter0 Crc_16
   Wake-UpFrame Filter Re7 : Filter3 Crc_16 - Filter2 Crc_16 */
