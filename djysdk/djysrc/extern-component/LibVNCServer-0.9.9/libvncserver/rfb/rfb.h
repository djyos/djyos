...
#define UPDATE_BUF_SIZE 30000
    ...
    ///////////////增加的变量////////////////////////
    rfbBool initdone;      //握手啥的完毕，可以发送信息了
    rfbBool framreq;       //有帧请求
    rfbBool increment;     //发送递增数据
    rfbBool badrout;       //链路通畅
    tagRecRegion reqregion;//感兴趣区域
    ///////////////////////////////////////////////
...
extern const char rfbEndianTest;
