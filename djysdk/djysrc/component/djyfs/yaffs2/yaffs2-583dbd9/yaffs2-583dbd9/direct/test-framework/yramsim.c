...
/******************************************************************************
*  创建设备块链表,实际上是在内存中开辟出一个FLASH的块链表
**/
...
{
	SimData *sim;
	struct ynandif_Geometry *g;/* 这个结构体需用户自己实现 */

	sim = yramsim_alloc_sim_data(devId, nBlocks);/* 内存中模拟一个FLASH空间 */
