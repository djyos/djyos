...
//根据浮点数的特征定义,查看长double和都变了是否相同
#if((DBL_MANT_DIG + DBL_DIG) == (LFLT_MANT_DIG + LDBL_DIG))
...
// lst
//NAN,在zmath.h和math.h中都有定义,导致重复。检查整个库,使用NAN的地方有两类,
//一是在numtest函数后判断结果,应使用zmath.h中的定义.
//2是检测到运算结果是NAN时,返回FP_ILOGBNAN或INT_MAX。
//# ifndef NAN
...
//# endif
 ...
 #ifndef HUGE_VAL
  #define HUGE_VAL (1.0e999999999)	//lst VC中认为“常亮太大，无法编译”
//  #define HUGE_VAL (3.40232347E+38)
 #endif

 #ifndef HUGE_VALF
  #define HUGE_VALF (1.0e999999999F)	//lst VC中认为“常亮太大，无法编译”
//   #define HUGE_VALF (3.40232347E+38F)
#endif

 #if !defined(HUGE_VALL)  &&  defined(_HAVE_LONG_DOUBLE)
  #define HUGE_VALL (1.0e999999999L)	//lst VC中认为“常亮太大，无法编译”
//   #define HUGE_VALL (3.40232347E+38L)
 #endif
...
//    * special case.  */
//   static const union { u32 __i[1]; float __d; } __Nanf = {0x7FC00000};
...
#ifdef __FAST_MATH__
//#include <machine/fastmath.h>  //lst todo 优化库时再说。
#endif
