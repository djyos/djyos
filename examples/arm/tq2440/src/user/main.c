...
#include "timer.h"
/*
#include "d:\testbmp\gray1_64x48.c"
#include "d:\testbmp\gray2_64x48.c"
#include "d:\testbmp\gray4_64x48.c"
#include "d:\testbmp\gray8_64x48.c"
#include "d:\testbmp\rgb565_240x180.c"
#include "d:\testbmp\index_4.c"
#include "d:\testbmp\tulips.c"
#include "d:\testbmp\Jellyfish.c"
*/
...
void dis_wnd_bottom_text(struct tagGkWinRsc *parent)
{
    ...
    if ((nowtime - last_nowtime) > 0)
    {
        ...
        GK_ApiDrawText(parent, 5, 5, text_time, strnlen(text_time, 100),
                            CN_COLOR_WHITE, CN_R2_COPYPEN,CN_TIMEOUT_FOREVER);
    }
}
#endif
...
//    test_sqlite1(0);
    ...
    GK_ApiDrawText(&wnd_banner, 60, 5,
