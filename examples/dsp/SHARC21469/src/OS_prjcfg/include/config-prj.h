...
#define cfg_extclk 8000000  //外部时钟=8M
...
#define cfg_locks_limit 30  //定义程序中可用的自由锁的数量。自由锁指用户调用semp_create和mutex_create创建的锁，不包括内核用到的锁。
#define cfg_events_limit 30  //事件数量
#define cfg_evtts_limit 20  //总事件类型数
#define cfg_paras_limit 100  //事件参数数量，
#define cfg_wdts_limit 20  //允许养狗数量
#define cfg_pipes_limit 1  //管道数量
...
#define cfg_cache_used 1  //cache
#define cfg_main_stack 153600  //main函数所需栈容量
